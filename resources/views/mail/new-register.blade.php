...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" style="max-width:800px;display: table; background-color:  #ffffff">
    ...
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
            <p style="padding: 5px;">I'm Ranvijay, the founder of {{ $setting['site_name'] }} and I'd like to personally thank you for signing up to our service.</p>
            <p style="padding: 5px;">We established {{ $setting['site_name'] }} in order to allow professionals like you to do more before & after online meetings.</p>
            <p style="padding: 5px;">I’d love to hear what you think of {{ $setting['site_name'] }} and if there is anything we can improve. If you have any questions, please reply to this email. I’m always happy to help!</p>
        </td>
    </tr>
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
    ...
    <tr>
        <td align="left" style="padding:0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
            ...
            <p style="padding: 5px">Ranvijay</p>
        </td>
    </tr>
    </tbody>
</table>
