...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" style="max-width:800px;display: table; background-color:  #ffffff">
    ...
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
            <p style="padding: 5px;">We received a request to reset your {{ $setting['site_name'] }} password. Please click below to reset your password. This link will expire in 24 hrs.</p>
            <p style="padding: 5px;"><a href="{{ route($data['route'], $data['link']) }}" target="_blank"
                                        style="padding: 5px; border: 2px solid #731d13; text-decoration: none; color: #731d13;">Reset password</a></p>
            <p style="padding: 5px">If you didn't request this password reset, contact {{ $setting['contact_email'] }} and report it.</p>
        </td>
    </tr>
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
