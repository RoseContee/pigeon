...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" style="max-width:800px;display: table; background-color:  #ffffff">
    ...
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
            <p style="padding: 5px;">Thanks for signing up with {{ $setting['site_name'] }}! You're nearly there towards completing your registration.
                Click below to confirm your email address.</p>
            <p style="padding: 5px;"><a href="{{ route('verify-email', $data['link']) }}" target="_blank"
                                        style="padding: 5px; border: 2px solid #731d13; text-decoration: none; color: #731d13;">Verify email</a></p>
            <p style="padding: 5px;">If you have problems, please paste this <b style="word-break: break-all;">{{ route('verify-email', $data['link']) }}</b> into your web browser.</p>
        </td>
    </tr>
    <tr>
        <td align="left" style="padding:10px 30px 0 30px; text-decoration: none; font-family: 'Raleway', Open Sans, sans-serif; font-size: 17px; line-height:30px; color:#000; font-weight:400;">
